...
Este proyecto es una aplicación de consola desarrollada en Java utilizando el framework Spring. Permite gestionar libros dentro de una biblioteca de manera sencilla, haciendo uso de una base de datos en memoria (H2).
...
- Consultar y actualizar libros (según lo implementado en el servicio).
- Persistencia en memoria con H2.
- Visualización de datos mediante la consola web de H2.
